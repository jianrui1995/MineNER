...
# 模型的存储路径
MODEL_PATH_SAVE = "../model/bilstm-att_all/"
# 模型保存的名字
...
# 训练句子的标签路径  选中
PRO_TRAIN_NEW_LABEL_PATH = '../Data/CCKS2019_subtask1/programed/train_label.txt'
# 训练句子的字数量路径  选中
PRO_TRAIN_NEW_SUM_PATH = '../Data/CCKS2019_subtask1/programed/train_sum.txt'
# 定义导入的数据类型  选中
